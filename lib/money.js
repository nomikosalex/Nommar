...
//   duet   → its fixed combined total (covers both guests)
//   normal → sum of component catalog prices (null if any component is unpriced)
export function packagePriceCents(pkg, priceMap) {
  if (pkg.duet) return pkg.totalPriceCents ?? null;
